# note_skills.md — Стандарти написання конспектів лекцій (notes.md)

> Цей файл є специфікацією для ШІ-агентів, що створюють або редагують файли `notes.md` у цьому репозиторії.  
...
Файл `notes.md` — це **повноцінний академічний конспект** лекції, призначений як для самостійного вивчення студентами, так і для автоматичного заповнення панелі SLIDE_NOTES у `presentation.html`.

**Розташування файлу:** `lectures/lecture-NN/notes.md`
...
- **Не** використовувати подвійні `||` або HTML-теги `<table>` у notes.md
...
Файли `notes.md` **можуть та мають** використовувати `mermaid.js` для відображення:
...
- Максимум 2–3 діаграми на весь файл `notes.md`
...
## 9. Відповідність між notes.md та презентацією

### 9.1 Структурна відповідність

- Кількість розділів `## N.` у `notes.md` **приблизно відповідає** кількості змістових слайдів у `presentation.html`
...
### 9.2 Вміст SLIDE_NOTES береться з notes.md

При генерації `SLIDE_NOTES` в `presentation.html`:
- Беремо перший і другий абзаци відповідного розділу notes.md
...
- Блоки коду в notes.md **не обов'язково** відображати у SLIDE_NOTES (вони займають багато місця)
- Довгі таблиці у notes.md можна скорочувати для SLIDE_NOTES (залишати 3–4 рядки)
- Mermaid-діаграми у notes.md **не відображаються** у SLIDE_NOTES (замінити на текстовий опис)

---

## 10. Чеклист якості notes.md

Перед збереженням файлу перевірити:

- [ ] Загальний обсяг: **9 000 – 12 000 слів** (перевіряти `wc -w notes.md`)
