...
| Параметр | Значення |
|----------|----------|
| Файл презентації | `lectures/lecture-07/_07_cloud.html` |
| Мова | Українська |
...
|------|-----------|---------|
| `_07_cloud.html` | 🔴 Критично | Перша половина готова (слайди 1-22). Додати слайди 23-38 |
...
- Перша половина презентації (слайди 1–22) вже збережена у `_07_cloud.html`
