...
| Параметр | Значення |
|----------|----------|
| Файл презентації | `lectures/lecture-07/presentation_07_cloud.html` |
| Мова | Українська |
...
## Файли, які ще потрібно створити

| Файл | Пріоритет | Нотатки |
|------|-----------|---------|
| `presentation_07_cloud.html` | 🔴 Критично | Перша половина готова (слайди 1-22). Додати слайди 23-38 |
| `README.md` | 🟡 Важливо | За зразком лекції 6 README.md |
| `references.md` | 🟡 Важливо | OWASP, AWS docs, 3GPP, RFC 3261 (SIP), GSMA FS.11 |
| `notes.md` | 🟢 Бажано | Детальний конспект по кожній темі |
| `notes.html` | 🟢 Бажано | HTML-версія notes.md (standalone, без Reveal.js) |
...
- Перша половина презентації (слайди 1–22) вже збережена у `presentation_07_cloud.html`
- Файл завершується НЕЗАКРИТИМИ тегами `</div></div></body></html>` — це НАВМИСНО
- Агент, що продовжує роботу, повинен **видалити** рядки із закриваючими тегами в кінці файлу і **додати** слайди 23–38, а потім закрити всі теги + Reveal.initialize()
- Точне місце для вставки позначено коментарем: `<!-- ===== КІНЕЦЬ ПЕРШОЇ ПОЛОВИНИ ===== -->`
- Після додавання слайдів 23–38 файл повинен завершуватись:
