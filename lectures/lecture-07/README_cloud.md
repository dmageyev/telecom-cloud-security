...
| Файл | Опис |
|------|------|
| [`presentation_07_cloud.html`](presentation_07_cloud.html) | Презентація Reveal.js (38 слайдів) |
...
Відкрийте файл `presentation_07_cloud.html` у браузері. Навігація:
...
← [Лекція 6 — Безпека обчислювальних сервісів і контейнерів](../lecture-06/presentation_06.html)  
