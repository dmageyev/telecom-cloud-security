...
| Файл | Опис |
|------|------|
| [`_07_cloud.html`](_07_cloud.html) | Презентація Reveal.js (38 слайдів) |
...
Відкрийте файл `_07_cloud.html` у браузері. Навігація:
...
← [Лекція 6 — Безпека обчислювальних сервісів і контейнерів](../lecture-06/_06.html)  
